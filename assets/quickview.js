...
function quickView() {
  ...
  $(".quick-view").click(function () {
    ...
    $('.template-collection').removeClass('unloading');
    ...
    $.fancybox({
      ...
      'beforeLoad': function () {
        ...
        $(document).on("click", ".qv-add-button", function () {
          ...
          console.log(".qv-add-button clicked!");
          ...
          $('#quick-view select').each(function (i) {
            ...
            if (selectedOptions == '') {
              console.log("selected options empty!");
              selectedOptions = $(this).val();

            } else {
              console.log("selected options detected!");
              selectedOptions = selectedOptions + ' / ' + $(this).val();
          ...
          jQuery.getJSON('/products/' + product_handle + '.js', function (product) {
            ...
            $(product.variants).each(function (i, v) {
              ...
              if (v.title == selectedOptions) {
                ...
                var_id = v.id;
                console.log("v.title == selectedOptions");
                processCart();
          ...
          console.log("before processCArt()");
