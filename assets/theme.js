    ...
    theme.Variants = (function() {
        ...
        Variants.prototype = Object.assign({}, Variants.prototype, {
            ...
            _updatePrice: function(variant) {
                ...
                //Global Variable For Variant (Rondel)
                //window.product_variant = "Testing!";
                //console.log(window.product_variant);
    ...
    theme.buildProductGridItem = function(items, imageSize) {
        ...
        <div class="grid-item grid-product">
          <div class="grid-item__content">
            <a href="${urlSplit[0]}" class="grid-item__link">
    ...
    DOMready(function(){
        ...
        document.addEventListener("bread-loaded", function(evt) {
            ...
            var opts = {
                ...
                customCSS: '#bread-button,body,html{height:100%;margin:0;width:100%}body{display:table}#bread-button{position:absolute;color:#000;text-align:center;vertical-align:middle;transition:all .3s ease;font-size: 15px;margin-top: 1.5px;font-family: sans-serif;font-weight: 500;}.bread-btn{cursor:pointer}.bread-embed-inner,.bread-label .bread-embed-icon{display:inline-block}.bread-label .bread-embed-icon:after{color:#333;content:"i";cursor:pointer;display:inline-block;line-height:1;margin-left:8px;padding:4px 9px}.bread-pot:before{content:"Low Monthly Payments";}.bread-btn .bread-as-low-as:before,.bread-label .bread-as-low-as:before{content:""}.bread-for:before{content:""}'
                /* END STEP 4 */
            };
            bread.checkout(opts)
            document.getElementById('bread-checkout-btn-new-bread-iframe').scrolling= "no";
            //console.log('Product variant is ' + window.product_variant);
        });
